...
// MARK: - Global Theme Colors (Minimal Pastel Butter & Rich Burgundy Theme)
var kBg          = NSColor(red: 254/255.0, green: 249/255.0, blue: 195/255.0, alpha: 1.00) // #FEF9C3 Pastel Butter
let kBlue        = NSColor(red: 128/255.0, green: 0/255.0,   blue: 32/255.0,  alpha: 1.00) // #800020 Rich Burgundy
...
let kAddBg       = NSColor(red: 128/255.0, green: 0/255.0,   blue: 32/255.0,  alpha: 1.00) // #800020 Rich Burgundy
let kDim         = NSColor(red: 89/255.0,  green: 89/255.0,  blue: 64/255.0,  alpha: 1.00) // #595940 Muted Olive
...
let kRadius: CGFloat = 16.0 // Smooth 16px rounded corners
