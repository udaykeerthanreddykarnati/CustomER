...
// MARK: - Minimal Theme Design Tokens
var kBg      = NSColor(hex: "#FEF9C3")! // Pastel Butter (#FEF9C3)
let kText    = NSColor(hex: "#800020")! // Rich Burgundy (#800020)
let kBlue    = NSColor(hex: "#800020")!
let kAccent  = NSColor(hex: "#800020")!
let kAddBg   = NSColor(hex: "#800020")!
let kDim     = NSColor(hex: "#595940")! // Muted Olive
let kSurface = NSColor(hex: "#FEFCE8")! // Soft Cream (#FEFCE8)
let kBorder  = NSColor.black            // Solid Black Border
let kRadius: CGFloat = 0.0              // Minimal: Sharp 0px Flat Corners (Exact Original)
let kBorderWidth: CGFloat = 1.0         // 1.0px Solid Border
...
class AddPanel: NSView {
    ...
    private func styleBtn(_ b: NSButton, primary: Bool, title: String) {
        ...
        b.contentTintColor = primary ? kSurface : kText
    }
...
class TodoView: NSView {
    ...
    private func build() {
        ...
        addBtn.contentTintColor = kSurface
    ...
    private func updateCalendar() {
        ...
        for i in 0..<35 {
            ...
            if dNum >= 1 && dNum <= numDays {
                ...
                if dNum == today {
                    lbl.backgroundColor = kAccent; lbl.textColor = kSurface; lbl.font = dynamicFont(size: 11, weight: .bold)
                } else {
...
class ColorPickerView: NSView {
    ...
    private func build() {
        ...
        pickerBtn.contentTintColor = kSurface
...
class SpotifyView: NSView {
    ...
    private func setupBtn(_ btn: NSButton, title: String, action: Selector) {
        ...
        btn.contentTintColor = kSurface; btn.target = self; btn.action = action; addSubview(btn)
    }
